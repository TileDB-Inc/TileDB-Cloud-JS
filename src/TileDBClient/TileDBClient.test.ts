...
describe('TileDBClient', () => {
  ...
  it('Should get array metadata', async () => {
    mock
      .onGet(`${BASE_PATH}/v1/arrays/ws_demo/ts_demo/demo/metadata`)
      .reply(200);
  ...
  it('Should get array activity', async () => {
    mock
      .onGet(`${BASE_PATH}/v1/arrays/ws_demo/ts_demo/demo/activity`)
      .reply(200);
  ...
  it('Should get deregister array', async () => {
    mock
      .onDelete(`${BASE_PATH}/v1/arrays/ws_demo/ts_demo/demo/deregister`)
      .reply(200);
  ...
  it('Should get register array', async () => {
    mock
      .onPost(`${BASE_PATH}/v1/arrays/ws_demo/ts_demo/demo/register`)
      .reply(200);
  ...
  it('Should share array', async () => {
    mock
      .onPatch(`${BASE_PATH}/v1/arrays/ws_demo/ts_demo/demo/share`)
      .reply(200);
  ...
  it('Should rename a notebook', async () => {
    mock
      .onPatch(`${BASE_PATH}/v1/notebooks/ws_demo/ts_demo/demo/rename`)
      .reply(200);
  ...
  it('Should initiate APIs with correct basePath', () => {
    ...
    expect(client.ArrayApi.basePath).toBe('https://api.dev.tiledb.io/v1');
    // @ts-expect-error: `basePath` is protected
    expect(client.OrganizationApi.basePath).toBe(
      'https://api.dev.tiledb.io/v1'
    );
    // @ts-expect-error: `basePath` is protected
    expect(client.UserApi.basePath).toBe('https://api.dev.tiledb.io/v1');
    // @ts-expect-error: `basePath` is protected
    expect(client.NotebookApi.basePath).toBe('https://api.dev.tiledb.io/v1');
    // @ts-expect-error: `basePath` is protected
    expect(client.TasksApi.basePath).toBe('https://api.dev.tiledb.io/v1');
