const bufferToData = require("../lib/utils/bufferToData");
...
describe("bufferToData()", () => {
    ...
    it('Should convert utf8 encoded to string', () => {
        ...
        const res = bufferToData.default(encodedStr.buffer, Datatype.StringUtf8);
    ...
    it('Should convert utf16 encoded to string', () => {
        ...
        const res = bufferToData.default(encodedStr.buffer, Datatype.StringUtf16);
    ...
    it('Should convert utf32 encoded to string', () => {
        ...
        const res = bufferToData.default(encodedStr.buffer, Datatype.StringUtf32);
    ...
    it('Should convert ascii encoded to string', () => {
        ...
        const res = bufferToData.default(encodedStr.buffer, Datatype.StringAscii);
