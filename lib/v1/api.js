...
const GroupsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listSharedGroups: (page, perPage, search, namespace, orderby, permissions, tag, excludeTag, flat, parent, options = {}) => __awaiter(this, void 0, void 0, function* () {
...
const GroupsApiFp = function (configuration) {
    ...
    return {
        ...
        listSharedGroups(page, perPage, search, namespace, orderby, permissions, tag, excludeTag, flat, parent, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.listSharedGroups(page, perPage, search, namespace, orderby, permissions, tag, excludeTag, flat, parent, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
...
class GroupsApi extends base_1.BaseAPI {
     ...
     */
    listSharedGroups(page, perPage, search, namespace, orderby, permissions, tag, excludeTag, flat, parent, options) {
        return exports.GroupsApiFp(this.configuration).listSharedGroups(page, perPage, search, namespace, orderby, permissions, tag, excludeTag, flat, parent, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Registers an existing group in the namespace.
     * @param {string} namespace The namespace of the group
