    ...
    return {
        ...
        arrayActivityLog(namespace, array, start, end, eventTypes, taskId, hasTaskId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                configuration.basePath = base_1.REDIRECT_PATH || configuration.basePath;
...
const GroupsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addAsset: (namespace, name, assetNamespace, assetName, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            common_1.assertParamExists('addAsset', 'namespace', namespace);
            // verify required parameter 'name' is not null or undefined
            common_1.assertParamExists('addAsset', 'name', name);
            // verify required parameter 'assetNamespace' is not null or undefined
            common_1.assertParamExists('addAsset', 'assetNamespace', assetNamespace);
            // verify required parameter 'assetName' is not null or undefined
            common_1.assertParamExists('addAsset', 'assetName', assetName);
         ...
         * @throws {RequiredError}
         */
        createGroup: (namespace, name, groupCreate, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            common_1.assertParamExists('createGroup', 'namespace', namespace);
            // verify required parameter 'name' is not null or undefined
            common_1.assertParamExists('createGroup', 'name', name);
         ...
         * @throws {RequiredError}
         */
        deleteGroup: (namespace, name, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            common_1.assertParamExists('deleteGroup', 'namespace', namespace);
            // verify required parameter 'name' is not null or undefined
            common_1.assertParamExists('deleteGroup', 'name', name);
            const localVarPath = `/groups/{namespace}/{name}`
                .replace(`{${"namespace"}}`, encodeURIComponent(String(namespace)))
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @throws {RequiredError}
         */
        listGroup: (namespace, name, output, page, perPage, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            common_1.assertParamExists('listGroup', 'namespace', namespace);
            // verify required parameter 'name' is not null or undefined
            common_1.assertParamExists('listGroup', 'name', name);
            const localVarPath = `/groups/{namespace}/{name}`
                .replace(`{${"namespace"}}`, encodeURIComponent(String(namespace)))
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @throws {RequiredError}
         */
        listTopLevelGroups: (namespace, page, perPage, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            common_1.assertParamExists('listTopLevelGroups', 'namespace', namespace);
         ...
         * @throws {RequiredError}
         */
        removeAsset: (namespace, name, assetNamespace, assetName, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            common_1.assertParamExists('removeAsset', 'namespace', namespace);
            // verify required parameter 'name' is not null or undefined
            common_1.assertParamExists('removeAsset', 'name', name);
            // verify required parameter 'assetNamespace' is not null or undefined
            common_1.assertParamExists('removeAsset', 'assetNamespace', assetNamespace);
            // verify required parameter 'assetName' is not null or undefined
            common_1.assertParamExists('removeAsset', 'assetName', assetName);
            const localVarPath = `/groups/{namespace}/{name}/{asset_namespace}/{asset_name}`
                .replace(`{${"namespace"}}`, encodeURIComponent(String(namespace)))
                .replace(`{${"name"}}`, encodeURIComponent(String(name)))
                .replace(`{${"asset_namespace"}}`, encodeURIComponent(String(assetNamespace)))
         ...
         * @throws {RequiredError}
         */
        updateGroup: (namespace, name, groupUpdate, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            common_1.assertParamExists('updateGroup', 'namespace', namespace);
            // verify required parameter 'name' is not null or undefined
            common_1.assertParamExists('updateGroup', 'name', name);
            const localVarPath = `/groups/{namespace}/{name}`
                .replace(`{${"namespace"}}`, encodeURIComponent(String(namespace)))
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
const GroupsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addAsset(namespace, name, assetNamespace, assetName, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.addAsset(namespace, name, assetNamespace, assetName, options);
                configuration.basePath = base_1.REDIRECT_PATH || configuration.basePath;
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
         ...
         * @throws {RequiredError}
         */
        createGroup(namespace, name, groupCreate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.createGroup(namespace, name, groupCreate, options);
                configuration.basePath = base_1.REDIRECT_PATH || configuration.basePath;
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
         ...
         * @throws {RequiredError}
         */
        deleteGroup(namespace, name, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.deleteGroup(namespace, name, options);
                configuration.basePath = base_1.REDIRECT_PATH || configuration.basePath;
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
         ...
         * @throws {RequiredError}
         */
        listGroup(namespace, name, output, page, perPage, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.listGroup(namespace, name, output, page, perPage, options);
                configuration.basePath = base_1.REDIRECT_PATH || configuration.basePath;
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
         ...
         * @throws {RequiredError}
         */
        listTopLevelGroups(namespace, page, perPage, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.listTopLevelGroups(namespace, page, perPage, options);
                configuration.basePath = base_1.REDIRECT_PATH || configuration.basePath;
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
         ...
         * @throws {RequiredError}
         */
        removeAsset(namespace, name, assetNamespace, assetName, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.removeAsset(namespace, name, assetNamespace, assetName, options);
                configuration.basePath = base_1.REDIRECT_PATH || configuration.basePath;
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
         ...
         * @throws {RequiredError}
         */
        updateGroup(namespace, name, groupUpdate, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.updateGroup(namespace, name, groupUpdate, options);
                configuration.basePath = base_1.REDIRECT_PATH || configuration.basePath;
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
...
class GroupsApi extends base_1.BaseAPI {
     ...
     */
    addAsset(namespace, name, assetNamespace, assetName, options) {
        return exports.GroupsApiFp(this.configuration).addAsset(namespace, name, assetNamespace, assetName, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Creates a new, empty group in the namespace.
     * @param {string} namespace The namespace of the group
     ...
     */
    createGroup(namespace, name, groupCreate, options) {
        return exports.GroupsApiFp(this.configuration).createGroup(namespace, name, groupCreate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Deletes the group and all the subgroups recursively. The assets are not deleted nor are not relocated to any other group
     * @param {string} namespace The namespace of the group
     ...
     */
    deleteGroup(namespace, name, options) {
        return exports.GroupsApiFp(this.configuration).deleteGroup(namespace, name, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns the contents, assets and subgroups, of the group
     * @param {string} namespace The namespace of the group
     ...
     */
    listGroup(namespace, name, output, page, perPage, options) {
        return exports.GroupsApiFp(this.configuration).listGroup(namespace, name, output, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns one page of top level groups in namespace.
     * @param {string} namespace The namespace to operate on
     ...
     */
    listTopLevelGroups(namespace, page, perPage, options) {
        return exports.GroupsApiFp(this.configuration).listTopLevelGroups(namespace, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Removes an asset from a group
     * @param {string} namespace The namespace of the group
     ...
     */
    removeAsset(namespace, name, assetNamespace, assetName, options) {
        return exports.GroupsApiFp(this.configuration).removeAsset(namespace, name, assetNamespace, assetName, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Changes attributes of the group
     * @param {string} namespace The namespace of the group
     ...
     */
    updateGroup(namespace, name, groupUpdate, options) {
        return exports.GroupsApiFp(this.configuration).updateGroup(namespace, name, groupUpdate, options).then((request) => request(this.axios, this.basePath));
    }
}
