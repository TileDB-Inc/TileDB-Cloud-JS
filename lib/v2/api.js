...
const ArrayApiAxiosParamCreator = function (configuration) {
    return {
        ...
        getArray: (namespace, array, contentType, arrayFetch, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            common_1.assertParamExists('getArray', 'arrayFetch', arrayFetch);
            ...
            localVarRequestOptions.data = common_1.serializeDataIfNeeded(arrayFetch, localVarRequestOptions, configuration);
            return {
                url: common_1.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
class ArrayApi extends base_1.BaseAPI {
     ...
     */
    getArray(namespace, array, contentType, arrayFetch, options) {
        return exports.ArrayApiFp(this.configuration).getArray(namespace, array, contentType, arrayFetch, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const FilesApiAxiosParamCreator = function (configuration) {
    return {
        ...
        handleUploadFile: (namespace, array, contentType, filesize, file, xTILEDBCLOUDACCESSCREDENTIALSNAME, name, filename, mimetype, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            // verify required parameter 'array' is not null or undefined
            common_1.assertParamExists('handleUploadFile', 'array', array);
            // verify required parameter 'contentType' is not null or undefined
            common_1.assertParamExists('handleUploadFile', 'contentType', contentType);
            // verify required parameter 'filesize' is not null or undefined
            common_1.assertParamExists('handleUploadFile', 'filesize', filesize);
            // verify required parameter 'file' is not null or undefined
            common_1.assertParamExists('handleUploadFile', 'file', file);
            ...
            localVarRequestOptions.data = common_1.serializeDataIfNeeded(file, localVarRequestOptions, configuration);
            return {
                url: common_1.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
class FilesApi extends base_1.BaseAPI {
     ...
     */
    handleUploadFile(namespace, array, contentType, filesize, file, xTILEDBCLOUDACCESSCREDENTIALSNAME, name, filename, mimetype, options) {
        return exports.FilesApiFp(this.configuration).handleUploadFile(namespace, array, contentType, filesize, file, xTILEDBCLOUDACCESSCREDENTIALSNAME, name, filename, mimetype, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const GroupsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        createGroup: (groupNamespace, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupCreation, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            common_1.assertParamExists('createGroup', 'groupNamespace', groupNamespace);
            ...
            localVarRequestOptions.data = common_1.serializeDataIfNeeded(groupCreation, localVarRequestOptions, configuration);
            return {
                url: common_1.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        deregisterGroup: (groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            common_1.assertParamExists('deregisterGroup', 'groupNamespace', groupNamespace);
            // verify required parameter 'groupName' is not null or undefined
            common_1.assertParamExists('deregisterGroup', 'groupName', groupName);
        ...
        getGroupMetadata: (groupNamespace, groupName, metadataRetrieval, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            common_1.assertParamExists('getGroupMetadata', 'groupNamespace', groupNamespace);
            // verify required parameter 'groupName' is not null or undefined
            common_1.assertParamExists('getGroupMetadata', 'groupName', groupName);
            ...
            localVarRequestOptions.data = common_1.serializeDataIfNeeded(metadataRetrieval, localVarRequestOptions, configuration);
            return {
                url: common_1.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        groupsGroupNamespaceGroupNameOptions: (groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            common_1.assertParamExists('groupsGroupNamespaceGroupNameOptions', 'groupNamespace', groupNamespace);
            // verify required parameter 'groupName' is not null or undefined
            common_1.assertParamExists('groupsGroupNamespaceGroupNameOptions', 'groupName', groupName);
            const localVarPath = `/groups/{group_namespace}/{group_name}`
                .replace(`{${"group_namespace"}}`, encodeURIComponent(String(groupNamespace)))
                .replace(`{${"group_name"}}`, encodeURIComponent(String(groupName)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        registerGroup: (groupNamespace, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupRegistration, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            common_1.assertParamExists('registerGroup', 'groupNamespace', groupNamespace);
            const localVarPath = `/groups/{group_namespace}`
                .replace(`{${"group_namespace"}}`, encodeURIComponent(String(groupNamespace)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            ...
            localVarRequestOptions.data = common_1.serializeDataIfNeeded(groupRegistration, localVarRequestOptions, configuration);
            return {
                url: common_1.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        retrieveGroup: (groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupRetrieval, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            common_1.assertParamExists('retrieveGroup', 'groupNamespace', groupNamespace);
            // verify required parameter 'groupName' is not null or undefined
            common_1.assertParamExists('retrieveGroup', 'groupName', groupName);
            const localVarPath = `/groups/{group_namespace}/{group_name}`
                .replace(`{${"group_namespace"}}`, encodeURIComponent(String(groupNamespace)))
                .replace(`{${"group_name"}}`, encodeURIComponent(String(groupName)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            localVarRequestOptions.data = common_1.serializeDataIfNeeded(groupRetrieval, localVarRequestOptions, configuration);
            return {
                url: common_1.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        updateGroupContents: (groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupUpdateContents, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            common_1.assertParamExists('updateGroupContents', 'groupNamespace', groupNamespace);
            // verify required parameter 'groupName' is not null or undefined
            common_1.assertParamExists('updateGroupContents', 'groupName', groupName);
            const localVarPath = `/groups/{group_namespace}/{group_name}`
                .replace(`{${"group_namespace"}}`, encodeURIComponent(String(groupNamespace)))
                .replace(`{${"group_name"}}`, encodeURIComponent(String(groupName)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            localVarRequestOptions.data = common_1.serializeDataIfNeeded(groupUpdateContents, localVarRequestOptions, configuration);
            return {
                url: common_1.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        updateGroupMetadata: (groupNamespace, groupName, metadataUpdating, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            common_1.assertParamExists('updateGroupMetadata', 'groupNamespace', groupNamespace);
            // verify required parameter 'groupName' is not null or undefined
            common_1.assertParamExists('updateGroupMetadata', 'groupName', groupName);
            const localVarPath = `/groups/{group_namespace}/{group_name}/metadata`
                .replace(`{${"group_namespace"}}`, encodeURIComponent(String(groupNamespace)))
                .replace(`{${"group_name"}}`, encodeURIComponent(String(groupName)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            localVarRequestOptions.data = common_1.serializeDataIfNeeded(metadataUpdating, localVarRequestOptions, configuration);
            return {
                url: common_1.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
class GroupsApi extends base_1.BaseAPI {
     ...
     */
    createGroup(groupNamespace, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupCreation, options) {
        return exports.GroupsApiFp(this.configuration).createGroup(groupNamespace, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupCreation, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Deregisters a group
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    deregisterGroup(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, options) {
        return exports.GroupsApiFp(this.configuration).deregisterGroup(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * get metadata on a group using the requested config
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    getGroupMetadata(groupNamespace, groupName, metadataRetrieval, options) {
        return exports.GroupsApiFp(this.configuration).getGroupMetadata(groupNamespace, groupName, metadataRetrieval, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * can be used to check if the resource exists
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    groupsGroupNamespaceGroupNameOptions(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, options) {
        return exports.GroupsApiFp(this.configuration).groupsGroupNamespaceGroupNameOptions(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Registers an already existing group
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    registerGroup(groupNamespace, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupRegistration, options) {
        return exports.GroupsApiFp(this.configuration).registerGroup(groupNamespace, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupRegistration, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves the contents of a group
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    retrieveGroup(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupRetrieval, options) {
        return exports.GroupsApiFp(this.configuration).retrieveGroup(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupRetrieval, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Change the contents of the group
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    updateGroupContents(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupUpdateContents, options) {
        return exports.GroupsApiFp(this.configuration).updateGroupContents(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupUpdateContents, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * update metadata on a group
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    updateGroupMetadata(groupNamespace, groupName, metadataUpdating, options) {
        return exports.GroupsApiFp(this.configuration).updateGroupMetadata(groupNamespace, groupName, metadataUpdating, options).then((request) => request(this.axios, this.basePath));
    }
}
