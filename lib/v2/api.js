...
exports.UserApi = exports.UserApiFactory = exports.UserApiFp = exports.UserApiAxiosParamCreator = exports.QueryApi = exports.QueryApiFactory = exports.QueryApiFp = exports.QueryApiAxiosParamCreator = exports.OrganizationApi = exports.OrganizationApiFactory = exports.OrganizationApiFp = exports.OrganizationApiAxiosParamCreator = exports.GroupsApi = exports.GroupsApiFactory = exports.GroupsApiFp = exports.GroupsApiAxiosParamCreator = exports.FilesApi = exports.FilesApiFactory = exports.FilesApiFp = exports.FilesApiAxiosParamCreator = exports.ArrayApi = exports.ArrayApiFactory = exports.ArrayApiFp = exports.ArrayApiAxiosParamCreator = exports.Querytype = exports.Querystatus = exports.Layout = exports.GroupMemberType = exports.GroupMemberAssetType = exports.FilterType = exports.Datatype = exports.CloudProvider = exports.ArrayType = exports.ActivityEventType = void 0;
...
(function (FilterType) {
    ...
    FilterType["ScaleFloat"] = "FILTER_SCALE_FLOAT";
    FilterType["Webp"] = "FILTER_WEBP";
    FilterType["ChecksumMd5"] = "FILTER_CHECKSUM_MD5";
    FilterType["ChecksumSha256"] = "FILTER_CHECKSUM_SHA256";
    FilterType["Dictionary"] = "FILTER_DICTIONARY";
...
const ArrayApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getArray: (namespace, array, contentType, arrayFetch, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            ...
            (0, common_1.assertParamExists)('getArray', 'arrayFetch', arrayFetch);
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(arrayFetch, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
const ArrayApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getArray(namespace, array, contentType, arrayFetch, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getArray(namespace, array, contentType, arrayFetch, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
    };
...
class ArrayApi extends base_1.BaseAPI {
     ...
     */
    arrayActivityLog(namespace, array, start, end, eventTypes, taskId, hasTaskId, page, perPage, options) {
        return (0, exports.ArrayApiFp)(this.configuration).arrayActivityLog(namespace, array, start, end, eventTypes, taskId, hasTaskId, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Get a array at a specified URI registered to a group/project
     * @param {string} namespace namespace array is in (an organization name or user\&#39;s username)
     ...
     */
    getArray(namespace, array, contentType, arrayFetch, options) {
        return (0, exports.ArrayApiFp)(this.configuration).getArray(namespace, array, contentType, arrayFetch, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const FilesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        handleUploadFile: (namespace, array, contentType, filesize, file, xTILEDBCLOUDACCESSCREDENTIALSNAME, name, filename, mimetype, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            (0, common_1.assertParamExists)('handleUploadFile', 'namespace', namespace);
            // verify required parameter 'array' is not null or undefined
            (0, common_1.assertParamExists)('handleUploadFile', 'array', array);
            // verify required parameter 'contentType' is not null or undefined
            (0, common_1.assertParamExists)('handleUploadFile', 'contentType', contentType);
            // verify required parameter 'filesize' is not null or undefined
            (0, common_1.assertParamExists)('handleUploadFile', 'filesize', filesize);
            // verify required parameter 'file' is not null or undefined
            (0, common_1.assertParamExists)('handleUploadFile', 'file', file);
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(file, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
const FilesApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        handleUploadFile(namespace, array, contentType, filesize, file, xTILEDBCLOUDACCESSCREDENTIALSNAME, name, filename, mimetype, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.handleUploadFile(namespace, array, contentType, filesize, file, xTILEDBCLOUDACCESSCREDENTIALSNAME, name, filename, mimetype, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
    };
...
class FilesApi extends base_1.BaseAPI {
     ...
     */
    handleUploadFile(namespace, array, contentType, filesize, file, xTILEDBCLOUDACCESSCREDENTIALSNAME, name, filename, mimetype, options) {
        return (0, exports.FilesApiFp)(this.configuration).handleUploadFile(namespace, array, contentType, filesize, file, xTILEDBCLOUDACCESSCREDENTIALSNAME, name, filename, mimetype, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const GroupsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        createGroup: (groupNamespace, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupCreation, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, common_1.assertParamExists)('createGroup', 'groupNamespace', groupNamespace);
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(groupCreation, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        deregisterGroup: (groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            (0, common_1.assertParamExists)('deregisterGroup', 'groupNamespace', groupNamespace);
            // verify required parameter 'groupName' is not null or undefined
            (0, common_1.assertParamExists)('deregisterGroup', 'groupName', groupName);
        ...
        getGroupMetadata: (groupNamespace, groupName, metadataRetrieval, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            (0, common_1.assertParamExists)('getGroupMetadata', 'groupNamespace', groupNamespace);
            // verify required parameter 'groupName' is not null or undefined
            (0, common_1.assertParamExists)('getGroupMetadata', 'groupName', groupName);
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(metadataRetrieval, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        groupsGroupNamespaceGroupNameOptions: (groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            (0, common_1.assertParamExists)('groupsGroupNamespaceGroupNameOptions', 'groupNamespace', groupNamespace);
            // verify required parameter 'groupName' is not null or undefined
            (0, common_1.assertParamExists)('groupsGroupNamespaceGroupNameOptions', 'groupName', groupName);
            const localVarPath = `/groups/{group_namespace}/{group_name}`
                .replace(`{${"group_namespace"}}`, encodeURIComponent(String(groupNamespace)))
                .replace(`{${"group_name"}}`, encodeURIComponent(String(groupName)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        registerGroup: (groupNamespace, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupRegistration, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            (0, common_1.assertParamExists)('registerGroup', 'groupNamespace', groupNamespace);
            const localVarPath = `/groups/{group_namespace}`
                .replace(`{${"group_namespace"}}`, encodeURIComponent(String(groupNamespace)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(groupRegistration, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        retrieveGroup: (groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupRetrieval, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            (0, common_1.assertParamExists)('retrieveGroup', 'groupNamespace', groupNamespace);
            // verify required parameter 'groupName' is not null or undefined
            (0, common_1.assertParamExists)('retrieveGroup', 'groupName', groupName);
            const localVarPath = `/groups/{group_namespace}/{group_name}`
                .replace(`{${"group_namespace"}}`, encodeURIComponent(String(groupNamespace)))
                .replace(`{${"group_name"}}`, encodeURIComponent(String(groupName)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(groupRetrieval, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        updateGroupContents: (groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupUpdateContents, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            (0, common_1.assertParamExists)('updateGroupContents', 'groupNamespace', groupNamespace);
            // verify required parameter 'groupName' is not null or undefined
            (0, common_1.assertParamExists)('updateGroupContents', 'groupName', groupName);
            const localVarPath = `/groups/{group_namespace}/{group_name}`
                .replace(`{${"group_namespace"}}`, encodeURIComponent(String(groupNamespace)))
                .replace(`{${"group_name"}}`, encodeURIComponent(String(groupName)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(groupUpdateContents, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        updateGroupMetadata: (groupNamespace, groupName, metadataUpdating, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupNamespace' is not null or undefined
            (0, common_1.assertParamExists)('updateGroupMetadata', 'groupNamespace', groupNamespace);
            // verify required parameter 'groupName' is not null or undefined
            (0, common_1.assertParamExists)('updateGroupMetadata', 'groupName', groupName);
            const localVarPath = `/groups/{group_namespace}/{group_name}/metadata`
                .replace(`{${"group_namespace"}}`, encodeURIComponent(String(groupNamespace)))
                .replace(`{${"group_name"}}`, encodeURIComponent(String(groupName)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(metadataUpdating, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
class GroupsApi extends base_1.BaseAPI {
     ...
     */
    createGroup(groupNamespace, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupCreation, options) {
        return (0, exports.GroupsApiFp)(this.configuration).createGroup(groupNamespace, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupCreation, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Deregisters a group
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    deregisterGroup(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, options) {
        return (0, exports.GroupsApiFp)(this.configuration).deregisterGroup(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * get metadata on a group using the requested config
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    getGroupMetadata(groupNamespace, groupName, metadataRetrieval, options) {
        return (0, exports.GroupsApiFp)(this.configuration).getGroupMetadata(groupNamespace, groupName, metadataRetrieval, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * can be used to check if the resource exists
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    groupsGroupNamespaceGroupNameOptions(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, options) {
        return (0, exports.GroupsApiFp)(this.configuration).groupsGroupNamespaceGroupNameOptions(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Registers an already existing group
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    registerGroup(groupNamespace, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupRegistration, options) {
        return (0, exports.GroupsApiFp)(this.configuration).registerGroup(groupNamespace, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupRegistration, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves the contents of a group
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    retrieveGroup(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupRetrieval, options) {
        return (0, exports.GroupsApiFp)(this.configuration).retrieveGroup(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupRetrieval, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Change the contents of the group
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    updateGroupContents(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupUpdateContents, options) {
        return (0, exports.GroupsApiFp)(this.configuration).updateGroupContents(groupNamespace, groupName, xTILEDBCLOUDACCESSCREDENTIALSNAME, groupUpdateContents, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * update metadata on a group
     * @param {string} groupNamespace The namespace of the group
     ...
     */
    updateGroupMetadata(groupNamespace, groupName, metadataUpdating, options) {
        return (0, exports.GroupsApiFp)(this.configuration).updateGroupMetadata(groupNamespace, groupName, metadataUpdating, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const OrganizationApiAxiosParamCreator = function (configuration) {
    return {
        ...
        addCredential: (namespace, accessCredential, provider, page, perPage, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            (0, common_1.assertParamExists)('addCredential', 'namespace', namespace);
            // verify required parameter 'accessCredential' is not null or undefined
            (0, common_1.assertParamExists)('addCredential', 'accessCredential', accessCredential);
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(accessCredential, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        deleteCredential: (namespace, name, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            (0, common_1.assertParamExists)('deleteCredential', 'namespace', namespace);
            // verify required parameter 'name' is not null or undefined
            (0, common_1.assertParamExists)('deleteCredential', 'name', name);
        ...
        getCredential: (namespace, name, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            (0, common_1.assertParamExists)('getCredential', 'namespace', namespace);
            // verify required parameter 'name' is not null or undefined
            (0, common_1.assertParamExists)('getCredential', 'name', name);
            const localVarPath = `/credentials/{namespace}/{name}`
                .replace(`{${"namespace"}}`, encodeURIComponent(String(namespace)))
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        listCredentials: (namespace, provider, page, perPage, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            (0, common_1.assertParamExists)('listCredentials', 'namespace', namespace);
            const localVarPath = `/credentials/{namespace}`
                .replace(`{${"namespace"}}`, encodeURIComponent(String(namespace)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
        ...
        updateCredential: (namespace, name, accessCredential, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
            (0, common_1.assertParamExists)('updateCredential', 'namespace', namespace);
            // verify required parameter 'name' is not null or undefined
            (0, common_1.assertParamExists)('updateCredential', 'name', name);
            // verify required parameter 'accessCredential' is not null or undefined
            (0, common_1.assertParamExists)('updateCredential', 'accessCredential', accessCredential);
            const localVarPath = `/credentials/{namespace}/{name}`
                .replace(`{${"namespace"}}`, encodeURIComponent(String(namespace)))
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
class OrganizationApi extends base_1.BaseAPI {
     ...
     */
    addCredential(namespace, accessCredential, provider, page, perPage, options) {
        return (0, exports.OrganizationApiFp)(this.configuration).addCredential(namespace, accessCredential, provider, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Delete the named access credential. Any arrays still set to use this credential will use the namespace\'s default and may become unreachable.
     * @param {string} namespace namespace
     ...
     */
    deleteCredential(namespace, name, options) {
        return (0, exports.OrganizationApiFp)(this.configuration).deleteCredential(namespace, name, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve an access credential by name
     * @param {string} namespace namespace
     ...
     */
    getCredential(namespace, name, options) {
        return (0, exports.OrganizationApiFp)(this.configuration).getCredential(namespace, name, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * List the credentials available in the namespace
     * @param {string} namespace namespace
     ...
     */
    listCredentials(namespace, provider, page, perPage, options) {
        return (0, exports.OrganizationApiFp)(this.configuration).listCredentials(namespace, provider, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Update the named access credential. This will also update the information used to access arrays set to use this credential.
     * @param {string} namespace namespace
     ...
     */
    updateCredential(namespace, name, accessCredential, options) {
        return (0, exports.OrganizationApiFp)(this.configuration).updateCredential(namespace, name, accessCredential, options).then((request) => request(this.axios, this.basePath));
    }
}
...
class QueryApi extends base_1.BaseAPI {
     ...
     */
    submitQuery(namespace, array, type, contentType, query, xPayer, openAt, readAll, options) {
        return (0, exports.QueryApiFp)(this.configuration).submitQuery(namespace, array, type, contentType, query, xPayer, openAt, readAll, options).then((request) => request(this.axios, this.basePath));
    }
}
...
class UserApi extends base_1.BaseAPI {
     ...
     */
    addCredential(namespace, accessCredential, provider, page, perPage, options) {
        return (0, exports.UserApiFp)(this.configuration).addCredential(namespace, accessCredential, provider, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Delete the named access credential. Any arrays still set to use this credential will use the namespace\'s default and may become unreachable.
     * @param {string} namespace namespace
     ...
     */
    deleteCredential(namespace, name, options) {
        return (0, exports.UserApiFp)(this.configuration).deleteCredential(namespace, name, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve an access credential by name
     * @param {string} namespace namespace
     ...
     */
    getCredential(namespace, name, options) {
        return (0, exports.UserApiFp)(this.configuration).getCredential(namespace, name, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * List the credentials available in the namespace
     * @param {string} namespace namespace
     ...
     */
    listCredentials(namespace, provider, page, perPage, options) {
        return (0, exports.UserApiFp)(this.configuration).listCredentials(namespace, provider, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Update the named access credential. This will also update the information used to access arrays set to use this credential.
     * @param {string} namespace namespace
     ...
     */
    updateCredential(namespace, name, accessCredential, options) {
        return (0, exports.UserApiFp)(this.configuration).updateCredential(namespace, name, accessCredential, options).then((request) => request(this.axios, this.basePath));
    }
}
