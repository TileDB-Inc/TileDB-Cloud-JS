...
const ArrayApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateArrayMetadataCap: (namespace, array, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'namespace' is not null or undefined
...
const ArrayApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updateArrayMetadataCap(namespace, array, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.updateArrayMetadataCap(namespace, array, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
...
class ArrayApi extends base_1.BaseAPI {
     ...
     */
    updateArrayMetadataCap(namespace, array, options) {
        return exports.ArrayApiFp(this.configuration).updateArrayMetadataCap(namespace, array, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * vacuum an array at a specified URI
     * @param {string} namespace namespace array is in (an organization name or user\&#39;s username)
