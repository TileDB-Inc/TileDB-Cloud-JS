...
exports.UdfApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getUDFSharingPolicies(namespace, name, options = {}) {
            // verify required parameter 'namespace' is not null or undefined
            if (namespace === null || namespace === undefined) {
                throw new base_1.RequiredError('namespace', 'Required parameter namespace was null or undefined when calling getUDFSharingPolicies.');
            }
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
                throw new base_1.RequiredError('name', 'Required parameter name was null or undefined when calling getUDFSharingPolicies.');
            }
         ...
         * @throws {RequiredError}
         */
        shareUDF(namespace, name, udfSharing, options = {}) {
            // verify required parameter 'namespace' is not null or undefined
            if (namespace === null || namespace === undefined) {
                throw new base_1.RequiredError('namespace', 'Required parameter namespace was null or undefined when calling shareUDF.');
            }
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
                throw new base_1.RequiredError('name', 'Required parameter name was null or undefined when calling shareUDF.');
            }
            // verify required parameter 'udfSharing' is not null or undefined
            if (udfSharing === null || udfSharing === undefined) {
                throw new base_1.RequiredError('udfSharing', 'Required parameter udfSharing was null or undefined when calling shareUDF.');
            }
            const localVarPath = `/udf/{namespace}/{name}/share`
                .replace(`{${"namespace"}}`, encodeURIComponent(String(namespace)))
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
...
exports.UdfApiFp = function (configuration) {
    return {
         ...
         */
        getUDFSharingPolicies(namespace, name, options) {
            const localVarAxiosArgs = exports.UdfApiAxiosParamCreator(configuration).getUDFSharingPolicies(namespace, name, options);
            return (axios = axios_1.default, basePath = base_1.BASE_PATH) => {
                const axiosRequestArgs = Object.assign(Object.assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
                return axios.request(axiosRequestArgs);
            };
         ...
         */
        shareUDF(namespace, name, udfSharing, options) {
            const localVarAxiosArgs = exports.UdfApiAxiosParamCreator(configuration).shareUDF(namespace, name, udfSharing, options);
            return (axios = axios_1.default, basePath = base_1.BASE_PATH) => {
                const axiosRequestArgs = Object.assign(Object.assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
                return axios.request(axiosRequestArgs);
            };
...
exports.UdfApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        getUDFSharingPolicies(namespace, name, options) {
            return exports.UdfApiFp(configuration).getUDFSharingPolicies(namespace, name, options)(axios, basePath);
        },
        /**
         * get a all UDFs accessible to the user
         * @param {string} [namespace] namespace to filter
         ...
         */
        shareUDF(namespace, name, udfSharing, options) {
            return exports.UdfApiFp(configuration).shareUDF(namespace, name, udfSharing, options)(axios, basePath);
        },
        /**
         * send a generic UDF in the given namespace
         * @param {string} namespace namespace array is in (an organization name or user\&#39;s username)
...
class UdfApi extends base_1.BaseAPI {
     ...
     */
    getUDFSharingPolicies(namespace, name, options) {
        return exports.UdfApiFp(this.configuration).getUDFSharingPolicies(namespace, name, options)(this.axios, this.basePath);
    }
    /**
     * get a all UDFs accessible to the user
     * @param {string} [namespace] namespace to filter
     ...
     */
    shareUDF(namespace, name, udfSharing, options) {
        return exports.UdfApiFp(this.configuration).shareUDF(namespace, name, udfSharing, options)(this.axios, this.basePath);
    }
    /**
     * send a generic UDF in the given namespace
     * @param {string} namespace namespace array is in (an organization name or user\&#39;s username)
