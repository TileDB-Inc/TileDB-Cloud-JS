                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (tag) {
                                localVarQueryParameter['tag'] = tag.join(base_1.COLLECTION_FORMATS.csv);
                            }
                            if (excludeTag) {
                                localVarQueryParameter['exclude_tag'] = excludeTag.join(base_1.COLLECTION_FORMATS.csv);
                            }
                            if (fileType) {
                                localVarQueryParameter['file_type'] = fileType.join(base_1.COLLECTION_FORMATS.csv);
                            }
                            if (excludeFileType) {
                                localVarQueryParameter['exclude_file_type'] = excludeFileType.join(base_1.COLLECTION_FORMATS.csv);
                            }
                            common_1.setSearchParams(localVarUrlObj, localVarQueryParameter, options.query);
                            headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                            localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
...
var TasksApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        taskIdRetryPost: function (id, acceptEncoding, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // verify required parameter 'id' is not null or undefined
                            common_1.assertParamExists('taskIdRetryPost', 'id', id);
                            localVarPath = "/task/{id}/retry"
                                .replace("{" + "id" + "}", encodeURIComponent(String(id)));
                            localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
                            if (configuration) {
                                baseOptions = configuration.baseOptions;
         ...
         * @throws {RequiredError}
         */
        tasksGet: function (namespace, createdBy, array, start, end, page, perPage, type, excludeType, status, search, orderby, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
    ...
    return {
        ...
        taskIdRetryPost: function (id, acceptEncoding, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.taskIdRetryPost(id, acceptEncoding, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, common_1.createRequestFunction(localVarAxiosArgs, axios_1["default"], base_1.BASE_PATH, configuration)];
                    }
        ...
        tasksGet: function (namespace, createdBy, array, start, end, page, perPage, type, excludeType, status, search, orderby, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.tasksGet(namespace, createdBy, array, start, end, page, perPage, type, excludeType, status, search, orderby, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, common_1.createRequestFunction(localVarAxiosArgs, axios_1["default"], base_1.BASE_PATH, configuration)];
                    }
...
var TasksApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         */
        taskIdRetryPost: function (id, acceptEncoding, options) {
            return localVarFp.taskIdRetryPost(id, acceptEncoding, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Fetch a list of all array tasks a user has access to
         * @param {string} [namespace] namespace to filter
         ...
         */
        tasksGet: function (namespace, createdBy, array, start, end, page, perPage, type, excludeType, status, search, orderby, options) {
            return localVarFp.tasksGet(namespace, createdBy, array, start, end, page, perPage, type, excludeType, status, search, orderby, options).then(function (request) { return request(axios, basePath); });
        }
    };
};
...
var TasksApi = /** @class */ (function (_super) {
     ...
     * @memberof TasksApi
     */
    TasksApi.prototype.taskIdRetryPost = function (id, acceptEncoding, options) {
        var _this = this;
        return exports.TasksApiFp(this.configuration).taskIdRetryPost(id, acceptEncoding, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * Fetch a list of all array tasks a user has access to
     * @param {string} [namespace] namespace to filter
     ...
     * @memberof TasksApi
     */
    TasksApi.prototype.tasksGet = function (namespace, createdBy, array, start, end, page, perPage, type, excludeType, status, search, orderby, options) {
        var _this = this;
        return exports.TasksApiFp(this.configuration).tasksGet(namespace, createdBy, array, start, end, page, perPage, type, excludeType, status, search, orderby, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return TasksApi;
}(base_1.BaseAPI));
