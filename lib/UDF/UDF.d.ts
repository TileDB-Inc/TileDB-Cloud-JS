...
declare class UDF {
    ...
    updateSignleArrayUdf(namespace: string, name: string, udf: Omit<UDFInfoUpdate, "type">): Promise<import("axios").AxiosResponse<void>>;
    ...
    unshare(namespace: string, udfName: string): Promise<import("axios").AxiosResponse<void>>;
