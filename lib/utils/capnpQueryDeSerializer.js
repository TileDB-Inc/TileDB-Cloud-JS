...
const bufferToData_1 = __importDefault(require("./bufferToData"));
    ...
    return ({
        ...
        ranges: subArray.getRanges().map((range) => {
            ...
            return {
                ...
                buffer: bufferToNumsArray(range.getBuffer().toArrayBuffer(), type),
...
const bufferToNumsArray = (buffer, type) => {
    const view = bufferToData_1.default(buffer, type);
    return typedArrayToArray_1.default(view);
};
