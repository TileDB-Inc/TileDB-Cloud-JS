...
const bufferToData = (arrayBuffer, type) => {
    if (type === v2_1.Datatype.Int32) {
        return (0, typedArrayToArray_1.default)((0, exports.bufferToInt32)(arrayBuffer));
    }
    else if (type === v2_1.Datatype.Uint64) {
        return (0, typedArrayToArray_1.default)((0, exports.bufferToUint64)(arrayBuffer));
    }
    else if (type === v2_1.Datatype.Int64) {
        return (0, typedArrayToArray_1.default)((0, exports.bufferToInt64)(arrayBuffer));
    }
    else if (type === v2_1.Datatype.Float32) {
        return (0, typedArrayToArray_1.default)((0, exports.bufferToFloat32)(arrayBuffer));
    }
    else if (type === v2_1.Datatype.Float64) {
        return (0, typedArrayToArray_1.default)((0, exports.bufferToFloat64)(arrayBuffer));
    }
    else if (type === v2_1.Datatype.Char) {
        const charCodes = (0, typedArrayToArray_1.default)((0, exports.bufferToUint8)(arrayBuffer));
        return String.fromCharCode(...charCodes);
    }
    else if (type === v2_1.Datatype.Int8) {
        return (0, typedArrayToArray_1.default)((0, exports.bufferToInt8)(arrayBuffer));
    }
    else if (type === v2_1.Datatype.Uint8) {
        return (0, typedArrayToArray_1.default)((0, exports.bufferToUint8)(arrayBuffer));
    }
    else if (type === v2_1.Datatype.Int16) {
        return (0, typedArrayToArray_1.default)((0, exports.bufferToInt16)(arrayBuffer));
    }
    else if (type === v2_1.Datatype.Uint16) {
        return (0, typedArrayToArray_1.default)((0, exports.bufferToUint16)(arrayBuffer));
    }
    else if (type === v2_1.Datatype.Uint32) {
        return (0, typedArrayToArray_1.default)((0, exports.bufferToUint32)(arrayBuffer));
    }
    else if (type === v2_1.Datatype.StringAscii) {
        return (0, exports.bufferToAscii)(arrayBuffer);
    }
    else if (type === v2_1.Datatype.StringUtf8) {
        return (0, exports.bufferToString)(arrayBuffer);
    }
    else if (type === v2_1.Datatype.StringUtf16) {
        return (0, exports.bufferToUTF16)(arrayBuffer);
    }
    else if (type === v2_1.Datatype.StringUtf32) {
        return (0, exports.bufferToUTF32)(arrayBuffer);
    }
