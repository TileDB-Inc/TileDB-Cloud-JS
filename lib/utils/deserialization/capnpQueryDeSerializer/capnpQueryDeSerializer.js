...
const capnpQueryDeSerializer = (buffer) => {
    ...
    return {
        ...
        type: query.getType(),
        writer: query.hasWriter() ? (0, exports.deserializeWrite)(query) : undefined,
        reader: query.hasReader() ? (0, exports.deserializeQueryReader)(query.getReader()) : undefined,
        array: query.hasArray() ? (0, exports.deserializeArray)(query.getArray()) : undefined,
        ...
        config: query.hasConfig() ? (0, exports.deserializeConfig)(query.getConfig()) : undefined,
        stats: query.hasStats() ? (0, exports.deserializeStats)(query.getStats()) : undefined,
    };
};
...
const deserializeArraySchema = (schema) => {
    return {
        ...
        domain: schema.hasDomain() ? (0, exports.deserializeDomain)(schema.getDomain()) : undefined,
...
const deserializeDomain = (domain) => {
    return {
        ...
        dimensions: domain.hasDimensions() ? domain.getDimensions().map(exports.deserializeDimension) : [],
    };
};
...
const deserializeDimension = (dimension) => {
    return {
        ...
        domain: dimension.hasDomain() ? (0, exports.deserializeDomainArray)(dimension.getDomain()) : undefined,
        nullTileExtent: dimension.getNullTileExtent(),
        tileExtent: (0, exports.deserializeTileExtent)(dimension.getTileExtent()),
        filterPipeline: dimension.hasFilterPipeline() ? (0, exports.deserializeFilterPipeline)(dimension.getFilterPipeline()) : {},
    };
};
