...
const deserializeFragmentMetadata = (fragmentMetadata) => {
    return {
        ...
        nonEmptyDomain: exports.deserializeNonEmptyDomainList(fragmentMetadata.getNonEmptyDomain()),
...
const deserializeMapEntry = (mapEntry) => {
    return {
        key: mapEntry.getKey(),
        value: exports.deserializeArraySchema(mapEntry.getValue())
    };
};
...
const deserializeFilter = (filter) => {
    return {
        ...
        floatScaleConfig: exports.deserializeFloatScaleConfig(filter.getFloatScaleConfig())
    };
};
