...
const checkRangeOutOfBounds_1 = __importDefault(require("./checkRangeOutOfBounds"));
/**
...
const getRanges = (ranges, dimensions, hasDefaultRange) => {
    return ranges.map((range = [], i) => {
        ...
        const domainKey = type === null || type === void 0 ? void 0 : type.toLowerCase();
        const bounds = (_a = dimension === null || dimension === void 0 ? void 0 : dimension.domain) === null || _a === void 0 ? void 0 : _a[domainKey];
        if (bounds && !checkRangeOutOfBounds_1.default(range, bounds)) {
            throw new Error(`Range ${JSON.stringify(range)} for dimension ${dimension === null || dimension === void 0 ? void 0 : dimension.name} is out of bounds`);
        }
