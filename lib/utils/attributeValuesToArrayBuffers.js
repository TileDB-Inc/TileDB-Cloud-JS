...
const attributeValuesToArrayBuffers = (values, dimensions, attributes) => {
    ...
    for (let [attrName, attribute] of Object.entries(values)) {
        ...
        data[attrName] = {
            offsetsBuffer: (0, dataToArrayBuffer_1.default)((0, mapToBigIntIfNeeded_1.default)(offsets, v2_1.Datatype.Uint64), v2_1.Datatype.Uint64),
            valuesBuffer: (0, dataToArrayBuffer_1.default)((0, mapToBigIntIfNeeded_1.default)(values, type), type),
            validityBuffer: (0, dataToArrayBuffer_1.default)(validity, v2_1.Datatype.Uint8),
        };
    }
    return data;
};
