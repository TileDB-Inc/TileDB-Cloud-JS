...
const getResultsFromArrayBuffer = (arrayBuffer, attributeBufferHeaders, attributesSchema, options = {}) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield attributeBufferHeaders
        ...
        if (isNullable && !options.ignoreNullables) {
            ...
            const values = convertToArray_1.default(result);
            result = (yield setNullables_1.default(values, nullablesArray, offsets));
        }
        /**
        ...
        if (isVarLengthSized &&
            ...
            const groupedValues = yield groupValuesByOffsetBytes_1.default(convertToArray_1.default(result), offsets);
            result = concatChars_1.default(groupedValues);
        }
        /**
         ...
         */
        if (isArrayOfArrays_1.default(result) && typeof result[0][0] === "string") {
            result = concatChars_1.default(result);
        }
