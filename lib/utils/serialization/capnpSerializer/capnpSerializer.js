...
const capnpArrayFetchSerializer_1 = __importDefault(require("../capnpArrayFetchSerializer"));
const capnpSerializer = (data) => {
    if (isArrayFetch(data)) {
        return (0, capnpArrayFetchSerializer_1.default)(data);
    }
