...
const serializeArray = (arrayCapNp, array) => {
    ...
    if ((_a = array.fragmentMetadataAll) === null || _a === void 0 ? void 0 : _a.length) {
        arrayCapNp
...
const serializeFragmentMetadataAll = (fragmentMetadataCapnp, fragmentMetadata) => {
    ...
    if ((_a = fragmentMetadata.fileSizes) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    if ((_b = fragmentMetadata.fileVarSizes) === null || _b === void 0 ? void 0 : _b.length) {
    ...
    if ((_c = fragmentMetadata.fileValiditySizes) === null || _c === void 0 ? void 0 : _c.length) {
    ...
    if ((_d = fragmentMetadata.tileOffsets) === null || _d === void 0 ? void 0 : _d.length) {
    ...
    if ((_e = fragmentMetadata.tileVarOffsets) === null || _e === void 0 ? void 0 : _e.length) {
    ...
    if ((_f = fragmentMetadata.tileVarSizes) === null || _f === void 0 ? void 0 : _f.length) {
    ...
    if ((_g = fragmentMetadata.tileValidityOffsets) === null || _g === void 0 ? void 0 : _g.length) {
    ...
    if ((_h = fragmentMetadata.tileMinBuffer) === null || _h === void 0 ? void 0 : _h.length) {
    ...
    if ((_j = fragmentMetadata.tileMinVarBuffer) === null || _j === void 0 ? void 0 : _j.length) {
    ...
    if ((_k = fragmentMetadata.tileMaxBuffer) === null || _k === void 0 ? void 0 : _k.length) {
    ...
    if ((_l = fragmentMetadata.tileMaxVarBuffer) === null || _l === void 0 ? void 0 : _l.length) {
    ...
    if ((_m = fragmentMetadata.tileSums) === null || _m === void 0 ? void 0 : _m.length) {
        serializeListListUint8(fragmentMetadataCapnp.initTileSums(fragmentMetadata.tileSums.length), fragmentMetadata.tileSums);
    }
    if ((_o = fragmentMetadata.tileNullCounts) === null || _o === void 0 ? void 0 : _o.length) {
    ...
    if ((_p = fragmentMetadata.fragmentMins) === null || _p === void 0 ? void 0 : _p.length) {
    ...
    if ((_q = fragmentMetadata.fragmentMaxs) === null || _q === void 0 ? void 0 : _q.length) {
    ...
    if ((_r = fragmentMetadata.fragmentSums) === null || _r === void 0 ? void 0 : _r.length) {
    ...
    if ((_s = fragmentMetadata.fragmentNullCounts) === null || _s === void 0 ? void 0 : _s.length) {
    ...
    if ((_t = fragmentMetadata.timestampRange) === null || _t === void 0 ? void 0 : _t.length) {
...
const serializeArrayDirectory = (arrayDirectoryCapnp, arrayDirectory) => {
    ...
    if ((_a = arrayDirectory.unfilteredFragmentUris) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    if ((_b = arrayDirectory.consolidatedCommitUris) === null || _b === void 0 ? void 0 : _b.length) {
    ...
    if ((_c = arrayDirectory.arraySchemaUris) === null || _c === void 0 ? void 0 : _c.length) {
    ...
    if ((_d = arrayDirectory.arrayMetaUrisToVacuum) === null || _d === void 0 ? void 0 : _d.length) {
    ...
    if ((_e = arrayDirectory.arrayMetaVacUrisToVacuum) === null || _e === void 0 ? void 0 : _e.length) {
    ...
    if ((_f = arrayDirectory.commitUrisToConsolidate) === null || _f === void 0 ? void 0 : _f.length) {
    ...
    if ((_g = arrayDirectory.commitUrisToVacuum) === null || _g === void 0 ? void 0 : _g.length) {
    ...
    if ((_h = arrayDirectory.consolidatedCommitUrisToVacuum) === null || _h === void 0 ? void 0 : _h.length) {
    ...
    if ((_j = arrayDirectory.arrayMetaUris) === null || _j === void 0 ? void 0 : _j.length) {
        arrayDirectoryCapnp
    ...
    if ((_k = arrayDirectory.fragmentMetaUris) === null || _k === void 0 ? void 0 : _k.length) {
    ...
    if ((_l = arrayDirectory.deleteAndUpdateTileLocation) === null || _l === void 0 ? void 0 : _l.length) {
        arrayDirectoryCapnp
