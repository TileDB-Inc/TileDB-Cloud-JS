...
const serializeArraySchemasAll = (arraySchemasAllCapnp, arraySchemasAll) => {
    ...
    entriesCapnp.forEach((entryCapnp, i) => {
        ...
        const arraySchemaCapnp = arrSchemaMsg.initRoot(query_capnp_1.ArraySchema);
        ...
        if ((_a = arraySchema.attributes) === null || _a === void 0 ? void 0 : _a.length) {
            ...
            attributes.forEach((attributeCapnp, i) => {
                ...
                if (attribute.filterPipeline) {
                    ...
                    const filterPipelinePointer = new capnp.Message().initRoot(query_capnp_1.FilterPipeline).segment.allocate(1000000);
                    const filterCapnp = new query_capnp_1.FilterPipeline(filterPipelinePointer.segment, filterPipelinePointer.byteOffset);
