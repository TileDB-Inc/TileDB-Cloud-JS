...
class TileDBQuery {
    ...
    ReadIncompleteQuery(arraySchema, queryAsArrayBuffer, namespace, arrayName, options, queryAPI) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    ReadQuery(namespace, arrayName, body) {
        ...
        return __asyncGenerator(this, arguments, function* ReadQuery_1() {
            ...
            try {
                 ...
                 */
                const queryResponse = yield __await(queryAPI.submitQuery(namespace, arrayName, v2_1.Querytype.Read, "application/capnp", dataToQuery_1.default(body, arraySchema.attributes, arraySchema.domain.dimensions, options), undefined, undefined, undefined, {
                    headers: {
                        "Content-Type": "application/capnp",
                    },
                    responseType: "arraybuffer",
                ...
                if (queryObject.status === v2_1.Querystatus.Incomplete) {
                    try {
                        ...
                        while (true) {
                            const { results, query, queryAsArrayBuffer } = yield __await(this.ReadIncompleteQuery(arraySchema, bufferWithoutFirstEightBytes, namespace, arrayName, options, queryAPI));
