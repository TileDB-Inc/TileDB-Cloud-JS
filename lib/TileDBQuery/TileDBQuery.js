        ...
        return __asyncGenerator(this, arguments, function* ReadQuery_1() {
            try {
                ...
                if (typeof arraySchema === "undefined") {
                    const arrayFromCapnp = yield __await(this.ArrayOpen(namespace, arrayName, v2_1.Querytype.Read));
                 ...
                 */
                const queryResponse = yield __await(this.queryAPI.submitQuery(namespace, arrayName, v2_1.Querytype.Read, "application/capnp", (0, dataToQuery_1.default)(body, arraySchema.attributes, arraySchema.domain.dimensions, options), undefined, undefined, undefined, {
                    headers: {
                        "Content-Type": "application/capnp",
                    },
                    responseType: "arraybuffer",
