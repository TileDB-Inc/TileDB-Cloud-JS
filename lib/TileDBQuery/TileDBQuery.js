...
const capnpQueryDeSerializer_1 = __importDefault(require("../utils/deserialization/capnpQueryDeSerializer"));
...
const capnpArrayDeserializer_1 = __importDefault(require("../utils/deserialization/capnpArrayDeserializer"));
const arrayFetchFromConfig_1 = __importDefault(require("../utils/arrayFetchFromConfig"));
const capnpArrayFetchSerializer_1 = __importDefault(require("../utils/serialization/capnpArrayFetchSerializer"));
const responseTypes_1 = __importDefault(require("../constants/responseTypes"));
class TileDBQuery {
    constructor(params, axios = axios_1.default) {
        var _a, _b;
        this.configurationParams = params;
        const config = new v3_1.Configuration(this.configurationParams);
        const baseV1 = (_a = config.basePath) === null || _a === void 0 ? void 0 : _a.replace("v2", "v1");
        const baseV3 = (_b = config.basePath) === null || _b === void 0 ? void 0 : _b.replace("v2", "v3");
        // Add versioning if basePath exists
        const configV1 = new v3_1.Configuration(Object.assign(Object.assign({}, this.configurationParams), (baseV1 ? { basePath: baseV1 } : {})));
        const configV3 = new v3_1.Configuration(Object.assign(Object.assign({}, this.configurationParams), (baseV3 ? { basePath: baseV3 } : {})));
        this.config = configV1;
        this.queryAPI = new v3_1.QueryApi(configV3, undefined, this.axios);
        this.arrayAPIV2 = new v2_1.ArrayApi(config, undefined, this.axios);
    }
    WriteQuery(namespace, arrayName, data) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const arrayStruct = yield this.ArrayOpen(namespace, arrayName, v3_1.Querytype.Write);
                const body = (0, getWriterBody_1.default)(data, arrayStruct);
                const queryResponse = yield this.queryAPI.submitQuery(namespace, arrayName, v3_1.Querytype.Write, "application/capnp", body, undefined, undefined, undefined, {
                    headers: {
                 ...
                 */
                const queryData = (0, convertToArrayBufferIfNodeBuffer_1.default)(queryResponse.data);
                const bufferWithoutFirstEightBytes = queryData.slice(8);
                return (0, capnpQueryDeSerializer_1.default)(bufferWithoutFirstEightBytes);
            }
            catch (e) {
                /**
                ...
                if (errorIsABuffer) {
                    const errorArrayBuffer = (0, convertToArrayBufferIfNodeBuffer_1.default)(e.response.data);
    ...
    ReadIncompleteQuery(arraySchema, queryAsArrayBuffer, namespace, arrayName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryResponse = yield this.queryAPI.submitQuery(namespace, arrayName, v3_1.Querytype.Read, "application/capnp", queryAsArrayBuffer, undefined, undefined, undefined, {
                headers: {
                    "Content-Type": "application/capnp",
                },
                responseType: "arraybuffer",
             ...
             */
            const queryObject = (0, capnpQueryDeSerializer_1.default)(bufferWithoutFirstEightBytes);
    ...
    ReadQuery(namespace, arrayName, body, arraySchema) {
        return __asyncGenerator(this, arguments, function* ReadQuery_1() {
            try {
                ...
                const arrayStruct = yield __await(this.ArrayOpen(namespace, arrayName, v3_1.Querytype.Read));
                if (!arraySchema) {
                    arraySchema = arrayStruct.arraySchemaLatest;
                }
                const options = {
                 ...
                 */
                const queryJSON = (0, dataToQuery_1.default)(body, arraySchema, arrayStruct, options);
                const queryResponse = yield __await(this.queryAPI.submitQuery(namespace, arrayName, v3_1.Querytype.Read, "application/capnp", queryJSON, undefined, undefined, undefined, {
                    headers: {
                        "Content-Type": "application/capnp",
                    },
                    responseType: "arraybuffer",
                ...
                if (queryObject.status === v3_1.Querystatus.Incomplete) {
                    try {
                        ...
                        while (true) {
                            ...
                            if (query.status === v3_1.Querystatus.Incomplete) {
    ...
    getResultsFromArrayBuffer(arraySchema, bufferResults, attributeHeaders, options) {
        return __awaiter(this, void 0, void 0, function* () {
             ...
             */
            const numberOfBytesOfResults = (0, getSizeInBytesOfAllAttributes_1.default)(attributeHeaders);
            /**
            ...
            // Calculate results
            const results = yield (0, getResultsFromArrayBuffer_1.default)(resultsBuffer, attributeHeaders, mergeAttributesAndDimensions, options);
            return results;
        });
    }
    throwError(e) {
    ...
    ArrayOpen(namespace, array, queryType, contentType = "application/json") {
        return __awaiter(this, void 0, void 0, function* () {
            const arrayFetch = (0, arrayFetchFromConfig_1.default)(this.config, queryType);
            const isJSONEncoded = contentType === 'application/json';
            const arrayFetchData = isJSONEncoded ? arrayFetch : (0, capnpArrayFetchSerializer_1.default)(arrayFetch);
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    const response = yield this.arrayAPIV2.getArray(namespace, array, contentType, arrayFetchData, {
                        headers: {
                            "Content-Type": contentType,
                        },
                        responseType: responseTypes_1.default[contentType],
                    });
                    if (isJSONEncoded) {
                        resolve(response.data);
                        return;
                    }
                    const arrayStructAsArrayBuffer = (0, convertToArrayBufferIfNodeBuffer_1.default)(response.data);
                    const deserializedArrayStruct = (0, capnpArrayDeserializer_1.default)(arrayStructAsArrayBuffer);
