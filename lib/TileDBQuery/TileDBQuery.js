...
class TileDBQuery {
    ...
    ReadQuery(namespace, arrayName, body, arraySchema, queryObj) {
        return __asyncGenerator(this, arguments, function* ReadQuery_1() {
            try {
                 ...
                 */
                const queryJSON = queryObj ? queryObj : (0, dataToQuery_1.default)(body, arraySchema, arrayStruct, options);
    ...
    ArrayOpen(namespace, array, queryType) {
        return __awaiter(this, void 0, void 0, function* () {
            const arrayFetch = (0, arrayFetchFromConfig_1.default)(this.config, queryType);
            const arrayFetchCapnp = (0, capnpArrayFetchSerializer_1.default)(arrayFetch);
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    const response = yield this.arrayAPIV2.getArray(namespace, array, "application/capnp", arrayFetchCapnp, {
                        headers: {
                            "Content-Type": "application/capnp",
                        },
                        responseType: "arraybuffer",
