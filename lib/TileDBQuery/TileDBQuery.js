...
class TileDBQuery {
    ...
    ReadIncompleteQuery(arraySchema, queryAsArrayBuffer, namespace, arrayName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const results = this.getResultsFromArrayBuffer(arraySchema, bufferWithoutFirstEightBytes, attributeHeaders, options);
            return {
                results,
                query: queryObject,
    ...
    getResultsFromArrayBuffer(arraySchema, bufferResults, attributeHeaders, options) {
        ...
        // Calculate results
        const results = getResultsFromArrayBuffer_1.default(resultsBuffer, attributeHeaders, mergeAttributesAndDimensions, options);
        return results;
    }
    throwError(e) {
        var _a, _b, _c, _d;
