...
class TileDBQuery {
    ...
    ArrayOpen(namespace, array, queryType) {
        return __awaiter(this, void 0, void 0, function* () {
            const arrayFetch = arrayFetchFromConfig_1.default(this.config, queryType);
            const arrayFetchCapnp = capnpArrayFetchSerializer_1.default(arrayFetch);
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const arrayStructAsArrayBuffer = convertToArrayBufferIfNodeBuffer_1.default(response.data);
                    const deserializedArrayStruct = capnpArrayDeserializer_1.default(arrayStructAsArrayBuffer);
