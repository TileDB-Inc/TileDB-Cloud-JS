    ...
    ReadQuery(namespace, arrayName, body, arraySchema) {
        return __asyncGenerator(this, arguments, function* ReadQuery_1() {
            try {
                 ...
                 */
                const queryResponse = yield __await(this.queryAPI.submitQuery(namespace, arrayName, v3_1.Querytype.Read, "application/capnp", (0, dataToQuery_1.default)(body, arraySchema, arrayStruct, options), undefined, undefined, undefined, {
                    headers: {
                        "Content-Type": "application/capnp",
                    },
                    responseType: "arraybuffer",
