...
class TileDBClient {
    constructor(params = defaultConfig) {
        ...
        this.config = new v2_1.Configuration(Object.assign(Object.assign({}, config), { 
            // for v1 API calls basePath needs /v1 suffix
            basePath: config.basePath + "/v1" }));
        // Add versioning if basePath exists
        this.configV2 = new v2_1.Configuration(Object.assign(Object.assign(Object.assign({}, defaultConfig), params), { 
            // for v2 API calls, basePath needs /v2 suffix
            basePath: config.basePath + "/v2" }));
        this.ArrayApi = new v1_1.ArrayApi(this.config, undefined, this.axios);
        this.OrganizationApi = new v1_1.OrganizationApi(this.config, undefined, this.axios);
        this.UserApi = new v1_1.UserApi(this.config, undefined, this.axios);
        this.NotebookApi = new v1_1.NotebookApi(this.config, undefined, this.axios);
        this.TasksApi = new v1_1.TasksApi(this.config, undefined, this.axios);
        this.udf = new UDF_1.default(this.config, this.axios);
        this.sql = new Sql_1.default(this.config, this.axios);
        this.groups = new Groups_1.default(this.config, this.configV2, this.axios);
        this.query = new TileDBQuery_1.default(this.configV2, this.axios);
    }
    ...
    downloadNotebookContents(namespace, notebook) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var _d = true, _e = __asyncValues(this.query.ReadQuery(namespace, notebook, query)), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        let results = _c;
    ...
    downloadNotebookToFile(namespace, notebook) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, save_file_1.default)(contents, `${notebook}.ipynb`);
        });
    }
    getFileContents(namespace, file) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var _d = true, _e = __asyncValues(this.query.ReadQuery(namespace, file, query)), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        let results = _c;
    ...
    downloadFile(namespace, file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, save_file_1.default)(buffer, originalFileName);
        });
    }
