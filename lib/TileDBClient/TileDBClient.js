...
class TileDBClient {
    constructor(params = defaultConfig) {
        ...
        this.ArrayApi = new v1_1.ArrayApi(this.config);
        this.OrganizationApi = new v1_1.OrganizationApi(this.config);
        this.UserApi = new v1_1.UserApi(this.config);
        this.NotebookApi = new v1_1.NotebookApi(this.config);
        this.TasksApi = new v1_1.TasksApi(this.config);
